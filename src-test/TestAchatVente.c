...
int main(int argc, char ** argv) {
	...
	if (mode == 0) {
		printf(
				"Prix d'achat de %d actions pour un stock de %d et une valeur intrinseque de %lg:\n ",
				Qte, Stock, VI);
		printf("%lg\n", PrixAchat(VI, Stock, Qte));
	} else if (mode == 1) {
		printf(
				"Prix de vente de %d actions pour un stock de %d et une valeur intrinseque de %lg:\n ",
				Qte, Stock, VI);
